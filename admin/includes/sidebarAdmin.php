<?php echo '<div class="card border-0 my-4" style="background: none">
        ...
        <div class="w-100">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu ms-5 bg-warning">
                        <li>
                            <a class="dropdown-item" href="pages/manage_product_group.php">
                        ...
                        <li>
                            <a class="dropdown-item" href="pages/manage_attribute_type.php"><span>QL Loại Thuộc tính</span></a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="pages/manage_attribute.php"><span>QL Thuộc tính</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
