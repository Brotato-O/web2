            ...
            <div>
                <form class="needs-validation" novalidate>
                    <div class="w-100 py-3">
                        <input type="email" class="form-control fs-5" id="validationCustom01" placeholder="Email"
                            required />
                        <div class="invalid-feedback">* Email không được để trống!</div>
                    </div>
                    <div class="w-100 pb-4">
                        <input type="password" class="form-control fs-5" id="validationCustom02" placeholder="Password"
                            required />
